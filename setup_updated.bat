...
copy /Y "%~dp0Champversity.DataAccess\Champversity.DataAccess.csproj.updated" "%~dp0Champversity.DataAccess\Champversity.DataAccess.csproj"
...
dotnet ef migrations add InitialCreate --project Champversity.DataAccess --startup-project Champversity.Web
